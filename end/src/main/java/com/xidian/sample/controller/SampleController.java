...
import com.xidian.module.credit.CreditService;
...
public class SampleController {
    ...
    @RequestMapping(value = "/sample/credit", method = {RequestMethod.POST})
    @ResponseBody
    public Object sampleCredit() {
        logger.info("sampleCredit|start");
        Map<String, Object> map = new HashMap<String, Object>();
        try {
            creditService.creaditQuery(map);
