...
insert into t_hots_kind(id, name, position, create_time, create_user, status)
values(1, "最新信用卡资讯", 1, now(), 0, 0),
(2, "最热理财资讯", 2, now(), 0, 0),
(3, "最新政策", 3, now(), 0, 0),
(4, "最新信用卡优惠", 4, now(), 0, 0),
(5, "最新贷款政策", 5, now(), 0, 0);
...
insert into t_hots(kind_id, name, content, position, create_time, create_user, status)
values(1, "最新信用卡资讯1", "最新信用卡资讯1内容", 1, now(), 0, 0),
(1, "最新信用卡资讯2", "最新信用卡资讯2内容", 2, now(), 0, 0),
(1, "最新信用卡资讯3", "最新信用卡资讯3内容", 3, now(), 0, 0),
(1, "最热理财资讯1", "最热理财资讯1内容", 1, now(), 0, 0),
(1, "最热理财资讯2", "最热理财资讯2内容", 1, now(), 0, 0),
(1, "最热理财资讯3", "最热理财资讯3内容", 1, now(), 0, 0),
(1, "最热理财资讯4", "最热理财资讯4内容", 1, now(), 0, 0),
(1, "最新政策1", "最新政策1内容", 1, now(), 0, 0),
(1, "最新政策2", "最新政策2内容", 1, now(), 0, 0),
(1, "最新信用卡优惠1", "最新信用卡优惠1内容", 1, now(), 0, 0),
(1, "最新贷款政策1", "最新贷款政策1内容", 1, now(), 0, 0);


insert into t_help_kind(id, name, icon, position, create_time, create_user, status)
values(1, "帮助与反馈问题1", "http://119.23.41.237:8180/front/static/images/bank.png", 1, now(), 0, 0),
(2, "帮助与反馈问题1", "http://119.23.41.237:8180/front/static/images/bank.png", 2, now(), 0, 0),
(3, "帮助与反馈问题3", "http://119.23.41.237:8180/front/static/images/bank.png", 3, now(), 0, 0),
(4, "帮助与反馈问题4", "http://119.23.41.237:8180/front/static/images/bank.png", 4, now(), 0, 0),
(5, "帮助与反馈问题5", "http://119.23.41.237:8180/front/static/images/bank.png", 5, now(), 0, 0);


insert into t_help(kind_id, name, content, flag, position, create_time, create_user, status)
values(1, "帮助与反馈问题1标题", "帮助与反馈问题1内容", "hot", 1, now(), 0, 0),
(1, "帮助与反馈问题2标题", "帮助与反馈问题2内容", "", 2, now(), 0, 0),
(1, "帮助与反馈问题3标题", "帮助与反馈问题3内容", "hot", 3, now(), 0, 0),
(1, "帮助与反馈问题4标题", "帮助与反馈问题4内容", "", 1, now(), 0, 0),
(1, "帮助与反馈问题5标题", "帮助与反馈问题5内容", "hot", 1, now(), 0, 0),
(1, "帮助与反馈问题6标题", "帮助与反馈问题6内容", "", 1, now(), 0, 0),
(1, "帮助与反馈问题7标题", "帮助与反馈问题7内容", "hot", 1, now(), 0, 0),
(1, "帮助与反馈问题8标题", "帮助与反馈问题8内容", "hot", 1, now(), 0, 0),
(1, "帮助与反馈问题9标题", "帮助与反馈问题9内容", "", 1, now(), 0, 0),
(1, "帮助与反馈问题10标题", "帮助与反馈问题10内容", "hot", 1, now(), 0, 0),
(1, "帮助与反馈问题11标题", "帮助与反馈问题11内容", "hot", 1, now(), 0, 0),
(2, "帮助与反馈问题5标题", "帮助与反馈问题5内容", "hot", 1, now(), 0, 0),
(3, "帮助与反馈问题6标题", "帮助与反馈问题6内容", "", 1, now(), 0, 0),
(4, "帮助与反馈问题7标题", "帮助与反馈问题7内容", "hot", 1, now(), 0, 0),
(5, "帮助与反馈问题8标题", "帮助与反馈问题8内容", "hot", 1, now(), 0, 0),
(3, "帮助与反馈问题9标题", "帮助与反馈问题9内容", "", 1, now(), 0, 0),
(5, "帮助与反馈问题10标题", "帮助与反馈问题10内容", "hot", 1, now(), 0, 0),
(9, "帮助与反馈问题11标题", "帮助与反馈问题11内容", "hot", 1, now(), 0, 0);